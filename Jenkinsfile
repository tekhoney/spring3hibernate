            ...
            steps {
                ...
                script {
                    ...
                    try {
                        ...
                        // Note: Agar 'color' label kaam na kare, toh aap ise 'app=spring-app-${targetColor}' se replace kar sakte hain
                        ...
                        if (!podIp || podIp == "null") {
                            error "Could not fetch Pod IP for health check. Check deployment labels."
                        }
